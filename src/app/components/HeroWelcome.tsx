...
export default function HeroWelcome() {
    ...
    return (
        <section
            ...
            style={{ minHeight: '100%', height: 'min(100vh, calc(100vw * 0.5625))' }}
        >
            ...
            <div className="flex justify-center mx-auto px-4 z-20">
                <div className="max-w-3xl">
                    <div className="text-white">
                        <h2 className="text-xl md:text-2xl uppercase tracking-widest opacity-90 mb-2">Bem-vindo 0</h2>
                        <div className="inline-block mb-4">
                            <h1 className="text-5xl md:text-8xl font-extrabold leading-tight font-lulo">ONE CHURCH</h1>
                            {/* Underline with 20px height */}
                            <div className="h-5 bg-[#19BA9B] mt-3 rounded-sm" aria-hidden="true" />
                        </div>

                        <div className="text-xl md:text-[52px] font-semibold leading-snug">
                            <p>UMA FAMÍLIA</p>
                            <p>PARA</p>
                            <p>PERTERNCER</p>
                        </div>
